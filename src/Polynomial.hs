...
--    p1 + p2 = case p1 of Const a1       -> case p2 of Const a2      -> Const (a1 + a2)
--                                                      Term a2 n2 r2 -> Term a2 n2 (p1 + r2)
--                         Term a1 n1 r1  -> case p2 of Const a2      -> Term a1 n1 (r1 + p2)
--                                                      Term a2 n2 r2 | n1 > n2 -> Term a1 n1 (r1 + p2)
